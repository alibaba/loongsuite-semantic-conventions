...
| `RERANKER` | Document reranking operation [15] | ![Development](https://img.shields.io/badge/-development-blue) |
| `RETRIEVER` | Document retrieval operation | ![Development](https://img.shields.io/badge/-development-blue) |
| `STEP` | ReAct iteration step identifier [16] | ![Development](https://img.shields.io/badge/-development-blue) |
...
| [`gen_ai.span.kind`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` [9] | string | The type of GenAI operation being performed. [10] | `LLM`; `RETRIEVER`; `EMBEDDING`; `TOOL`; `AGENT` |
| [`gen_ai.span_kind_name`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` [11] | string | The type of GenAI operation being performed. [12] | `LLM`; `RETRIEVER`; `EMBEDDING`; `TOOL`; `AGENT` |
| [`server.port`](/docs/registry/attributes/server.md) | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | `Conditionally Required` If `server.address` is set. | int | GenAI server port. [13] | `80`; `8080`; `443` |
...
**[9] `gen_ai.span.kind`:** if `loongsuite.semconv.dialect.name` is set to `alibaba_cloud` (default) or not set

**[10] `gen_ai.span.kind`:** Dedicated GenAI span classification attribute for the `alibaba_cloud` dialect. See the dialect switch documentation in `gen_ai.span.kind` for details.

**[11] `gen_ai.span_kind_name`:** if `loongsuite.semconv.dialect.name` is set to `alibaba_group`

**[12] `gen_ai.span_kind_name`:** Dedicated GenAI span classification attribute for the `alibaba_group` dialect. See the dialect switch documentation in `gen_ai.span_kind_name` for details.
...
| `LLM` | Model invocation (chat, generate_content, text_completion) | ![Development](https://img.shields.io/badge/-development-blue) |
| `RERANKER` | Document reranking operation [24] | ![Development](https://img.shields.io/badge/-development-blue) |
| `RETRIEVER` | Document retrieval operation | ![Development](https://img.shields.io/badge/-development-blue) |
...
| `AGENT` | Agent invocation or creation operation | ![Development](https://img.shields.io/badge/-development-blue) |
| `EMBEDDING` | Embedding operation | ![Development](https://img.shields.io/badge/-development-blue) |
| `ENTRY` | Entry point invocation identifier for AI application system [26] | ![Development](https://img.shields.io/badge/-development-blue) |
| `LLM` | Model invocation (chat, generate_content, text_completion) | ![Development](https://img.shields.io/badge/-development-blue) |
