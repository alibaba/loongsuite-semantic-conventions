...
| `ENTRY` | Entry point invocation identifier for AI application system [12] | ![Development](https://img.shields.io/badge/-development-blue) |
| `LLM` | Model invocation (chat, generate_content, text_completion) | ![Development](https://img.shields.io/badge/-development-blue) |
| `MCP` | Tool execution via Model Context Protocol (MCP) [13] | ![Development](https://img.shields.io/badge/-development-blue) |
| `RERANKER` | Document reranking operation [14] | ![Development](https://img.shields.io/badge/-development-blue) |
| `RETRIEVER` | Document retrieval operation | ![Development](https://img.shields.io/badge/-development-blue) |
| `STEP` | ReAct iteration step identifier [15] | ![Development](https://img.shields.io/badge/-development-blue) |
| `TOOL` | Tool execution operation | ![Development](https://img.shields.io/badge/-development-blue) |
| `WORKFLOW` | GenAI workflow invocation operation [16] | ![Development](https://img.shields.io/badge/-development-blue) |

**[12]:** Not yet defined in OTel community.

**[13]:** Not yet defined in OTel community.
...
| `LLM` | Model invocation (chat, generate_content, text_completion) | ![Development](https://img.shields.io/badge/-development-blue) |
| `MCP` | Tool execution via Model Context Protocol (MCP) [18] | ![Development](https://img.shields.io/badge/-development-blue) |
| `RERANKER` | Document reranking operation [19] | ![Development](https://img.shields.io/badge/-development-blue) |
| `RETRIEVER` | Document retrieval operation | ![Development](https://img.shields.io/badge/-development-blue) |
| `STEP` | ReAct iteration step identifier [20] | ![Development](https://img.shields.io/badge/-development-blue) |
| `TOOL` | Tool execution operation | ![Development](https://img.shields.io/badge/-development-blue) |
| `WORKFLOW` | GenAI workflow invocation operation [21] | ![Development](https://img.shields.io/badge/-development-blue) |
...
| `AGENT` | Agent invocation or creation operation | ![Development](https://img.shields.io/badge/-development-blue) |
| `EMBEDDING` | Embedding operation | ![Development](https://img.shields.io/badge/-development-blue) |
| `ENTRY` | Entry point invocation identifier for AI application system [21] | ![Development](https://img.shields.io/badge/-development-blue) |
| `LLM` | Model invocation (chat, generate_content, text_completion) | ![Development](https://img.shields.io/badge/-development-blue) |
| `MCP` | Tool execution via Model Context Protocol (MCP) [22] | ![Development](https://img.shields.io/badge/-development-blue) |
| `RERANKER` | Document reranking operation [23] | ![Development](https://img.shields.io/badge/-development-blue) |
| `RETRIEVER` | Document retrieval operation | ![Development](https://img.shields.io/badge/-development-blue) |
| `STEP` | ReAct iteration step identifier [24] | ![Development](https://img.shields.io/badge/-development-blue) |
| `TOOL` | Tool execution operation | ![Development](https://img.shields.io/badge/-development-blue) |
| `WORKFLOW` | GenAI workflow invocation operation [25] | ![Development](https://img.shields.io/badge/-development-blue) |
...
| `LLM` | Model invocation (chat, generate_content, text_completion) | ![Development](https://img.shields.io/badge/-development-blue) |
| `MCP` | Tool execution via Model Context Protocol (MCP) [27] | ![Development](https://img.shields.io/badge/-development-blue) |
| `RERANKER` | Document reranking operation [28] | ![Development](https://img.shields.io/badge/-development-blue) |
| `RETRIEVER` | Document retrieval operation | ![Development](https://img.shields.io/badge/-development-blue) |
| `STEP` | ReAct iteration step identifier [29] | ![Development](https://img.shields.io/badge/-development-blue) |
| `TOOL` | Tool execution operation | ![Development](https://img.shields.io/badge/-development-blue) |
| `WORKFLOW` | GenAI workflow invocation operation [30] | ![Development](https://img.shields.io/badge/-development-blue) |
