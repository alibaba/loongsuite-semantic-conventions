...
| `RERANKER` | Document reranking operation [13] | ![Development](https://img.shields.io/badge/-development-blue) |
| `RETRIEVER` | Document retrieval operation | ![Development](https://img.shields.io/badge/-development-blue) |
| `STEP` | ReAct iteration step identifier [14] | ![Development](https://img.shields.io/badge/-development-blue) |
