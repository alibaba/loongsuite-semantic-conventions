...
**[2] `gen_ai.input.messages`:** when the context changes in a non-append-only way and cannot be reconstructed from previous request/response logs and the current delta
