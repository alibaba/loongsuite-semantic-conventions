...
- [Agent and Tool Metrics](#agent-and-tool-metrics)
...
The following metrics describe GenAI workflow and skill operations.
...
The following metrics describe GenAI agent and tool operations.
