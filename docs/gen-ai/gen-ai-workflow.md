...
Describes GenAI workflow invocation.
...
* [`gen_ai.workflow.name`](/docs/registry/attributes/gen-ai.md)
...
| `invoke_workflow` | Invoke a GenAI workflow | ![Development](https://img.shields.io/badge/-development-blue) |
