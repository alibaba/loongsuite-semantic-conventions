...
| [`gen_ai.iteration.per_token_total_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | int[] | Cumulative number of tokens generated by the engine or scheduler for each output token. [17] | `[4096, 4097, 4098]` |
...
| [`gen_ai.latency.per_token_generation_time`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | double[] | Relative generation or emission timestamp for each output token. [19] | `[0.0031, 0.0059, 0.0088]` |
| [`gen_ai.latency.per_token_scheduled_time`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | double[] | Relative scheduling timestamp for each output token. [20] | `[0.001, 0.004, 0.007]` |
...
| [`gen_ai.response.per_token_candidate_decoded_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | any | Candidate decoded token strings for each generated token position. [22] | [<br>&nbsp;&nbsp;["Hello", "Hello", "Hi"],<br>&nbsp;&nbsp;["there", "world", "there"]<br>] |
| [`gen_ai.response.per_token_candidate_token_ids`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | any | Candidate token identifiers for each generated token position. [23] | [<br>&nbsp;&nbsp;[15043, 15043, 1723],<br>&nbsp;&nbsp;[1052, 995, 1052]<br>] |
| [`gen_ai.response.per_token_candidate_tokens_logprobs`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | any | Candidate token log probabilities for each generated token position. [24] | [<br>&nbsp;&nbsp;[-1.03, -0.12, -1.03],<br>&nbsp;&nbsp;[-0.05, -0.05, -2.11]<br>] |
| [`gen_ai.response.per_token_num_new_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | int[] | Number of newly generated tokens associated with each recorded output token position. [25] | `[2, 3, 1]` |
...
**[17] `gen_ai.iteration.per_token_total_tokens`:** There SHOULD be one value per generated output token position.

**[18] `gen_ai.iteration.per_token_waiting_requests`:** There SHOULD be one value per generated output token position.

**[19] `gen_ai.latency.per_token_generation_time`:** The values are relative to the start of the span or request and measured in seconds. There SHOULD be one value per generated output token.

**[20] `gen_ai.latency.per_token_scheduled_time`:** The values are relative to the start of the span or request and measured in seconds. There SHOULD be one value per generated output token.
...
**[22] `gen_ai.response.per_token_candidate_decoded_tokens`:** It's expected to be an array of arrays where the outer array indexes
...
**[23] `gen_ai.response.per_token_candidate_token_ids`:** It's expected to be an array of arrays where the outer array indexes
the generated token position and the inner array contains candidate
...
**[24] `gen_ai.response.per_token_candidate_tokens_logprobs`:** It's expected to be an array of arrays where the outer array indexes
the generated token position and the inner array contains candidate
...
**[25] `gen_ai.response.per_token_num_new_tokens`:** This attribute is primarily intended for multi-token prediction systems.
