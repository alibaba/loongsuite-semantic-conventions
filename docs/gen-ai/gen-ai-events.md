...
| [`gen_ai.span.kind`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` [7] | string | The type of GenAI operation being performed. [8] | `LLM`; `RETRIEVER`; `EMBEDDING`; `TOOL`; `AGENT` |
| [`gen_ai.span_kind_name`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` [9] | string | The type of GenAI operation being performed. [10] | `LLM`; `RETRIEVER`; `EMBEDDING`; `TOOL`; `AGENT` |
...
**[7] `gen_ai.span.kind`:** if `loongsuite.semconv.dialect.name` is set to `alibaba_cloud` (default) or not set
...
**[9] `gen_ai.span_kind_name`:** if `loongsuite.semconv.dialect.name` is set to `alibaba_group`
