...
| [`gen_ai.iteration.per_token_waiting_size`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | int[] | Number of requests waiting in the scheduler queue when each output token was scheduled. [19] | `[120, 98, 105]` |
...
**[19] `gen_ai.iteration.per_token_waiting_size`:** There SHOULD be one value per generated output token position.
