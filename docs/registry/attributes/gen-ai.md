...
| <a id="gen-ai-operation-name" href="#gen-ai-operation-name">`gen_ai.operation.name`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The name of the operation being performed. [7] | `chat`; `generate_content`; `text_completion` |
| <a id="gen-ai-output-messages" href="#gen-ai-output-messages">`gen_ai.output.messages`</a> | ![Development](https://img.shields.io/badge/-development-blue) | any | Messages returned by the model where each message represents a specific model response (choice, candidate). [8] | [<br>&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;"role": "assistant",<br>&nbsp;&nbsp;&nbsp;&nbsp;"parts": [<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"type": "text",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"content": "The weather in Paris is currently rainy with a temperature of 57°F."<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;&nbsp;&nbsp;]<br>&nbsp;&nbsp;}<br>] |
| <a id="gen-ai-output-type" href="#gen-ai-output-type">`gen_ai.output.type`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | Represents the content type requested by the client. [9] | `text`; `json`; `image` |
...
| <a id="gen-ai-provider-name" href="#gen-ai-provider-name">`gen_ai.provider.name`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The Generative AI provider as identified by the client or server instrumentation. [10] | `openai`; `gcp.gen_ai`; `gcp.vertex_ai` |
| <a id="gen-ai-react-finish-reason" href="#gen-ai-react-finish-reason">`gen_ai.react.finish_reason`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The reason why this ReAct iteration ended. [11] | `stop`; `tool_calls` |
| <a id="gen-ai-react-round" href="#gen-ai-react-round">`gen_ai.react.round`</a> | ![Development](https://img.shields.io/badge/-development-blue) | int | The round number (1-based) of the current ReAct iteration within the agent loop. [12] | `1`; `2`; `3` |
...
| <a id="gen-ai-response-candidate-decoded-tokens" href="#gen-ai-response-candidate-decoded-tokens">`gen_ai.response.candidate.decoded_tokens`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string[] | Candidate decoded token strings associated with an output token event. [17] | `["Hello", "Hi"]` |
| <a id="gen-ai-response-candidate-logprobs" href="#gen-ai-response-candidate-logprobs">`gen_ai.response.candidate.logprobs`</a> | ![Development](https://img.shields.io/badge/-development-blue) | double[] | Log probabilities for candidate tokens associated with an output token event. [18] | `[-0.12, -1.03]` |
| <a id="gen-ai-response-candidate-per-position-decoded-tokens" href="#gen-ai-response-candidate-per-position-decoded-tokens">`gen_ai.response.candidate.per_position_decoded_tokens`</a> | ![Development](https://img.shields.io/badge/-development-blue) | any | Candidate decoded token strings for each generated token position. [19] | [<br>&nbsp;&nbsp;["Hello", "Hello", "Hi"],<br>&nbsp;&nbsp;["there", "world", "there"]<br>] |
| <a id="gen-ai-response-candidate-per-position-logprobs" href="#gen-ai-response-candidate-per-position-logprobs">`gen_ai.response.candidate.per_position_logprobs`</a> | ![Development](https://img.shields.io/badge/-development-blue) | any | Candidate token log probabilities for each generated token position. [20] | [<br>&nbsp;&nbsp;[-1.03, -0.12, -1.03],<br>&nbsp;&nbsp;[-0.05, -0.05, -2.11]<br>] |
| <a id="gen-ai-response-candidate-per-position-token-ids" href="#gen-ai-response-candidate-per-position-token-ids">`gen_ai.response.candidate.per_position_token_ids`</a> | ![Development](https://img.shields.io/badge/-development-blue) | any | Candidate token identifiers for each generated token position. [21] | [<br>&nbsp;&nbsp;[15043, 15043, 1723],<br>&nbsp;&nbsp;[1052, 995, 1052]<br>] |
| <a id="gen-ai-response-candidate-token-ids" href="#gen-ai-response-candidate-token-ids">`gen_ai.response.candidate.token_ids`</a> | ![Development](https://img.shields.io/badge/-development-blue) | int[] | Candidate token identifiers associated with an output token event. [22] | `[15043, 1723]` |
| <a id="gen-ai-response-finish-reasons" href="#gen-ai-response-finish-reasons">`gen_ai.response.finish_reasons`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string[] | Array of reasons the model stopped generating tokens, corresponding to each generation received. [23] | `["stop"]`; `["stop", "length"]`; `["error"]` |
...
| <a id="gen-ai-response-per-token-new-tokens" href="#gen-ai-response-per-token-new-tokens">`gen_ai.response.per_token_new_tokens`</a> | ![Development](https://img.shields.io/badge/-development-blue) | int[] | Number of newly generated tokens associated with each recorded output token position. [24] | `[2, 3, 1]` |
| <a id="gen-ai-response-per-token-time-to-generate" href="#gen-ai-response-per-token-time-to-generate">`gen_ai.response.per_token_time_to_generate`</a> | ![Development](https://img.shields.io/badge/-development-blue) | double[] | Time elapsed from span start to each token generation, in seconds. [25] | `[0.0031, 0.0059, 0.0088]` |
| <a id="gen-ai-response-per-token-time-to-schedule" href="#gen-ai-response-per-token-time-to-schedule">`gen_ai.response.per_token_time_to_schedule`</a> | ![Development](https://img.shields.io/badge/-development-blue) | double[] | Time elapsed from span start to each token scheduling, in seconds. [26] | `[0.001, 0.004, 0.007]` |
...
| <a id="gen-ai-span-kind" href="#gen-ai-span-kind">`gen_ai.span.kind`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The type of GenAI operation being performed. [29] | `LLM`; `RETRIEVER`; `EMBEDDING`; `TOOL`; `AGENT` |
| <a id="gen-ai-span-kind-name" href="#gen-ai-span-kind-name">`gen_ai.span_kind_name`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The type of GenAI operation being performed. [30] | `LLM`; `RETRIEVER`; `EMBEDDING`; `TOOL`; `AGENT` |
...
| <a id="gen-ai-usage-cache-creation-input-tokens" href="#gen-ai-usage-cache-creation-input-tokens">`gen_ai.usage.cache_creation.input_tokens`</a> | ![Development](https://img.shields.io/badge/-development-blue) | int | The number of input tokens written to a provider-managed cache. [36] | `25` |
| <a id="gen-ai-usage-cache-read-input-tokens" href="#gen-ai-usage-cache-read-input-tokens">`gen_ai.usage.cache_read.input_tokens`</a> | ![Development](https://img.shields.io/badge/-development-blue) | int | The number of input tokens served from a provider-managed cache. [37] | `50` |
| <a id="gen-ai-usage-input-tokens" href="#gen-ai-usage-input-tokens">`gen_ai.usage.input_tokens`</a> | ![Development](https://img.shields.io/badge/-development-blue) | int | The number of tokens used in the GenAI input (prompt). [38] | `100` |
...
| <a id="gen-ai-workflow-name" href="#gen-ai-workflow-name">`gen_ai.workflow.name`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | Human-readable name of the GenAI workflow provided by the application. [39] | `multi_agent_rag`; `customer_support_pipeline` |
...
When system or developer instructions are recorded in
`gen_ai.system_instructions`, instrumentations SHOULD NOT duplicate
the same instructions in `gen_ai.input.messages`.
...
`gen_ai.output.messages` SHOULD only contain generated content parts
needed to replay or inspect the candidate content. Instrumentations SHOULD
NOT duplicate response envelope metadata in `gen_ai.output.messages` when
that metadata is represented by normalized attributes. This includes
finish reasons, token usage, costs, response identifiers, model names,
and response timing metadata.
...
**[11] `gen_ai.react.finish_reason`:** Indicates why a ReAct step concluded. Common values include `stop`
...
**[14] `gen_ai.rerank.input_documents`:** Instrumentations MUST follow [Rerank input documents JSON schema](/docs/gen-ai/gen-ai-rerank-input-documents.json).
When the attribute is recorded on events, it MUST be recorded in structured
form. When recorded on spans, it MAY be recorded as a JSON string if structured
format is not supported and SHOULD be recorded in structured form otherwise.
...
**[15] `gen_ai.rerank.output_documents`:** Instrumentations MUST follow [Rerank output documents JSON schema](/docs/gen-ai/gen-ai-rerank-output-documents.json).
When the attribute is recorded on events, it MUST be recorded in structured
form. When recorded on spans, it MAY be recorded as a JSON string if structured
format is not supported and SHOULD be recorded in structured form otherwise.
...
**[16] `gen_ai.rerank.query.text`:** The text of the query being used to rerank the documents.

> [!Warning]
> This attribute may contain sensitive information.

**[17] `gen_ai.response.candidate.decoded_tokens`:** The values SHOULD be ordered by rank with the emitted token first when it is known.

**[18] `gen_ai.response.candidate.logprobs`:** The values SHOULD align with `gen_ai.response.candidate.decoded_tokens` and `gen_ai.response.candidate.token_ids`.

**[19] `gen_ai.response.candidate.per_position_decoded_tokens`:** It's expected to be an array of arrays where the outer array indexes
...
**[20] `gen_ai.response.candidate.per_position_logprobs`:** It's expected to be an array of arrays where the outer array indexes
the generated token position and the inner array contains candidate
...
**[21] `gen_ai.response.candidate.per_position_token_ids`:** It's expected to be an array of arrays where the outer array indexes
the generated token position and the inner array contains candidate
...
**[25] `gen_ai.response.per_token_time_to_generate`:** Array values are aligned with output token positions. Each value represents the relative timestamp when that token was generated.

**[26] `gen_ai.response.per_token_time_to_schedule`:** Array values are aligned with output token positions. Each value represents the relative timestamp when that token was scheduled.

**[27] `gen_ai.retrieval.documents`:** Instrumentations MUST follow [Retrieval documents JSON schema](/docs/gen-ai/gen-ai-retrieval-documents.json).
When the attribute is recorded on events, it MUST be recorded in structured
form. When recorded on spans, it MAY be recorded as a JSON string if structured
format is not supported and SHOULD be recorded in structured form otherwise.
...
**[29] `gen_ai.span.kind`:** `gen_ai.span.kind` is a dedicated GenAI span classification attribute, distinct from OTel's standard `SpanKind`.
...
**[30] `gen_ai.span_kind_name`:** `gen_ai.span_kind_name` is an alias of `gen_ai.span.kind` for the `alibaba_group` semantic convention dialect.
...
When `gen_ai.system_instructions` is recorded, instrumentations SHOULD NOT
duplicate the same system or developer instructions in `gen_ai.input.messages`.
...
**[34] `gen_ai.tool.definitions`:** The value of this attribute matches source system tool definition format.
...
**[36] `gen_ai.usage.cache_creation.input_tokens`:** The value SHOULD be included in `gen_ai.usage.input_tokens`.

**[37] `gen_ai.usage.cache_read.input_tokens`:** The value SHOULD be included in `gen_ai.usage.input_tokens`.

**[38] `gen_ai.usage.input_tokens`:** This value SHOULD include all types of input tokens, including cached tokens.
Instrumentations SHOULD make a best effort to populate this value, using a total
provided by the provider when available or, depending on the provider API,
by summing different token types parsed from the provider output.

**[39] `gen_ai.workflow.name`:** This attribute can be populated in different frameworks eg: name of the first chain in LangChain OR name of the crew in CrewAI.
...
| `react` | ReAct (Reasoning-Acting) step within a GenAI agent loop [40] | ![Development](https://img.shields.io/badge/-development-blue) |
...
**[40]:** This value is used for the ReAct step span that wraps individual reasoning-acting cycles within an agent loop. It is an Alibaba Cloud extension.
...
| `gcp.gemini` | Gemini [44] | ![Development](https://img.shields.io/badge/-development-blue) |
| `gcp.gen_ai` | Any Google generative AI endpoint [45] | ![Development](https://img.shields.io/badge/-development-blue) |
| `gcp.vertex_ai` | Vertex AI [46] | ![Development](https://img.shields.io/badge/-development-blue) |
...
**[44]:** This refers to the 'generativelanguage.googleapis.com' endpoint. Also known as the AI Studio API. May use common attributes prefixed with 'gcp.gen_ai.'.

**[45]:** May be used when specific backend is unknown. May use common attributes prefixed with 'gcp.gen_ai.'.

**[46]:** This refers to the 'aiplatform.googleapis.com' endpoint. May use common attributes prefixed with 'gcp.gen_ai.'.
