...
| <a id="gen-ai-input-messages-delta" href="#gen-ai-input-messages-delta">`gen_ai.input.messages_delta`</a> | ![Development](https://img.shields.io/badge/-development-blue) | any | New messages appended to the model input since the previous request's input messages and output messages combined. [8] | [<br>&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;"role": "tool",<br>&nbsp;&nbsp;&nbsp;&nbsp;"parts": [<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"type": "tool_call_response",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"id": "call_VSPygqKTWdrhaFErNvMV18Yl",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"result": "rainy, 57°F"<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;&nbsp;&nbsp;]<br>&nbsp;&nbsp;}<br>] |
...
| <a id="gen-ai-react-finish-reason" href="#gen-ai-react-finish-reason">`gen_ai.react.finish_reason`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The reason why this ReAct iteration ended. [16] | `stop`; `tool_calls` |
| <a id="gen-ai-react-round" href="#gen-ai-react-round">`gen_ai.react.round`</a> | ![Development](https://img.shields.io/badge/-development-blue) | int | The round number (1-based) of the current ReAct iteration within the agent loop. [17] | `1`; `2`; `3` |
...
**[9] `gen_ai.iteration.per_token_batch_size`:** There SHOULD be one value per generated output token position.

**[10] `gen_ai.iteration.per_token_cumulative_count`:** There SHOULD be one value per generated output token position.

**[11] `gen_ai.iteration.per_token_waiting_requests`:** There SHOULD be one value per generated output token position.
...
**[15] `gen_ai.provider.name`:** The attribute SHOULD be set based on the instrumentation's best
...
**[16] `gen_ai.react.finish_reason`:** Indicates why a ReAct step concluded. Common values include `stop`
(model produced a final answer) and `tool_calls` (model invoked a tool).

**[17] `gen_ai.react.round`:** Indicates which round this ReAct step represents, starting from 1.
