...
| <a id="gen-ai-retrieval-documents" href="#gen-ai-retrieval-documents">`gen_ai.retrieval.documents`</a> | ![Development](https://img.shields.io/badge/-development-blue) | any | The documents retrieved. [11] | [<br>&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;"id": "doc_123",<br>&nbsp;&nbsp;&nbsp;&nbsp;"score": 0.95<br>&nbsp;&nbsp;},<br>&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;"id": "doc_456",<br>&nbsp;&nbsp;&nbsp;&nbsp;"score": 0.87<br>&nbsp;&nbsp;},<br>&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;"id": "doc_789",<br>&nbsp;&nbsp;&nbsp;&nbsp;"score": 0.82<br>&nbsp;&nbsp;}<br>] |
| <a id="gen-ai-retrieval-query-text" href="#gen-ai-retrieval-query-text">`gen_ai.retrieval.query.text`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The query text used for retrieval. [12] | `What is the capital of France?`; `weather in Paris` |
| <a id="gen-ai-session-id" href="#gen-ai-session-id">`gen_ai.session.id`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | A unique identifier for the GenAI session. [13] | `sess_abc123` |
| <a id="gen-ai-span-kind" href="#gen-ai-span-kind">`gen_ai.span.kind`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | Dedicated span kind enum for identifying specific span purposes within GenAI agent workflows. [14] | `STEP` |
...
| <a id="gen-ai-user-id" href="#gen-ai-user-id">`gen_ai.user.id`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | A unique identifier for the end user. [23] | `user_456`; `alice@example.com` |
...
**[11] `gen_ai.retrieval.documents`:** Instrumentations MUST follow [Retrieval documents JSON schema](/docs/gen-ai/gen-ai-retrieval-documents.json).
When the attribute is recorded on events, it MUST be recorded in structured
form. When recorded on spans, it MAY be recorded as a JSON string if structured
format is not supported and SHOULD be recorded in structured form otherwise.
...
**[12] `gen_ai.retrieval.query.text`:**

> [!Warning]
> This attribute may contain sensitive information.

**[13] `gen_ai.session.id`:** Identifies the session that the GenAI interaction belongs to.
Conditionally required when session management is enabled.

**[14] `gen_ai.span.kind`:** When set to `STEP`, the span represents a single ReAct iteration turn. This is an Alibaba Cloud extension and not part of the upstream OpenTelemetry semantic conventions.
...
| `react` | ReAct (Reasoning-Acting) iteration loop for GenAI agents [25] | ![Development](https://img.shields.io/badge/-development-blue) |
...
**[25]:** This value is used for the ReAct iteration span that wraps individual reasoning-acting cycles within an agent loop. It is an Alibaba Cloud extension.
...
| Value | Description | Stability |
| --- | --- | --- |
| `STEP` | Wraps a single iteration (turn) within a ReAct loop of a Reasoning-Acting agent. [29] | ![Development](https://img.shields.io/badge/-development-blue) |

**[29]:** This span kind is an Alibaba Cloud extension. It is used to identify individual ReAct iteration turns within an agent loop, enabling clear isolation and analysis of each reasoning-acting cycle.
...
| `gcp.gemini` | Gemini [30] | ![Development](https://img.shields.io/badge/-development-blue) |
| `gcp.gen_ai` | Any Google generative AI endpoint [31] | ![Development](https://img.shields.io/badge/-development-blue) |
| `gcp.vertex_ai` | Vertex AI [32] | ![Development](https://img.shields.io/badge/-development-blue) |
...
**[30]:** This refers to the 'generativelanguage.googleapis.com' endpoint. Also known as the AI Studio API. May use common attributes prefixed with 'gcp.gen_ai.'.

**[31]:** May be used when specific backend is unknown. May use common attributes prefixed with 'gcp.gen_ai.'.

**[32]:** This refers to the 'aiplatform.googleapis.com' endpoint. May use common attributes prefixed with 'gcp.gen_ai.'.
